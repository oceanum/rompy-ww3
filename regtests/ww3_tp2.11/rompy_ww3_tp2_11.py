...
def create_ww3_tp2_11_config():
    ...
    grid_component = Grid(
        ...
        curv=Curv(
            ...
            ny=121,
            xcoord=CoordData(
                filename=WW3DataBlob(source="../ww3_tp2.9/input/curv_2d.lon"),
                sf=0.0001,
                off=0.0,
                idf=11,
                idla=1,
            ...
            ycoord=CoordData(
                filename=WW3DataBlob(source="../ww3_tp2.9/input/curv_2d.lat"),
                sf=0.0001,
                off=0.0,
                idf=12,
                idla=1,
        ...
        depth=Depth(
            filename=WW3DataBlob(source="../ww3_tp2.9/input/curv_2d.bot"),
            sf=0.001,
        ),
        mask=Mask(
            filename=WW3DataBlob(source="../ww3_tp2.9/input/curv_2d.mask"),
        ),
        obstacle=Obstacle(
            filename=WW3DataBlob(source="../ww3_tp2.9/input/curv_2d.obs"),
            sf=0.01,
        ),
    )
