...
class NamelistBaseModel(BaseModel):
    ...
    def render(self) -> str:
        ...
        lines = []
        lines.append(f"! Generated by rompy-ww3")
        ...
        namelist_prefix = namelist_name[:-4] if namelist_name.endswith("_NML") else namelist_name
            ...
            if isinstance(value, dict):
                ...
                for sub_key, sub_value in value.items():
                    if sub_value is not None:
                        ...
                        formatted_key = f"{namelist_prefix}%{key.upper()}%{sub_key.upper()}"
