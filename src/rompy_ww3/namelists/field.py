...
class Field(NamelistBaseModel):
    ...
    partition: Optional[str] = Field(
        default=None,
        description="List of wave partitions ['0 1 2 3']"
    )
    samefile: Optional[bool] = Field(
        default=None,
        description="All the variables in the same file"
    )
    ...
    type: Optional[int] = Field(
        default=None,
        description="[2 = SHORT, 3 = it depends , 4 = REAL]"
    )
    fcvars: Optional[bool] = Field(
        default=None,
        description="Generate auxiliary forecast variables"
    )
    ...
    timevar: Optional[str] = Field(
        default=None,
        description="Time var type ['D' = DOUBLE, 'I' = INT64]"
    )
    timeunit: Optional[str] = Field(
        default=None,
        description="Time units ['D' = days, 'I' = seconds]"
    )
    timeepoch: Optional[str] = Field(
        default=None,
        description="Epoch used for encoding of NC time variables"
    )
    noval: Optional[float] = Field(
        default=None,
        description="Value for wet cells that have an UNDEF value"
    )
    mapsta: Optional[bool] = Field(
        default=None,
        description="Output MAPSTA field in file?"
    )