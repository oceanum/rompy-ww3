...
class Grid(NamelistBaseModel):
    ...
    nml: Optional[str] = Field(
        default=None,
        description="Namelist file name"
    )
...
class Rect(NamelistBaseModel):
    ...
    sx: Optional[float] = Field(
        default=None,
        description="Grid increment along x-axis"
    )
    sy: Optional[float] = Field(
        default=None,
        description="Grid increment along y-axis"
    )
    sf: Optional[float] = Field(
        default=None,
        description="Scaling factor for grid increments"
    )