...
class InputForcing(NamelistBaseModel):
    ...
    water_levels: Optional[str] = Field(
        default=None,
        description="Water level forcing flag ('F', 'T', 'H', 'C')"
    )
    currents: Optional[str] = Field(
        default=None,
        description="Current forcing flag ('F', 'T', 'H', 'C')"
    )
    winds: Optional[str] = Field(
        default=None,
        description="Wind forcing flag ('F', 'T', 'H', 'C')"
    )
    ...
    air_density: Optional[str] = Field(
        default=None,
        description="Air density forcing flag ('F', 'T', 'H', 'C')"
    )
    ice_conc: Optional[str] = Field(
        default=None,
        description="Ice concentration forcing flag ('F', 'T', 'H', 'C')"
    )
    ice_param1: Optional[str] = Field(
        default=None,
        description="Ice parameter 1 forcing flag ('F', 'T', 'H', 'C')"
    )
    ice_param2: Optional[str] = Field(
        default=None,
        description="Ice parameter 2 forcing flag ('F', 'T', 'H', 'C')"
    )
    ice_param3: Optional[str] = Field(
        default=None,
        description="Ice parameter 3 forcing flag ('F', 'T', 'H', 'C')"
    )
    ice_param4: Optional[str] = Field(
        default=None,
        description="Ice parameter 4 forcing flag ('F', 'T', 'H', 'C')"
    )
    ice_param5: Optional[str] = Field(
        default=None,
        description="Ice parameter 5 forcing flag ('F', 'T', 'H', 'C')"
    )
    mud_density: Optional[str] = Field(
        default=None,
        description="Mud density forcing flag ('F', 'T', 'H', 'C')"
    )
    mud_thickness: Optional[str] = Field(
        default=None,
        description="Mud thickness forcing flag ('F', 'T', 'H', 'C')"
    )
    mud_viscosity: Optional[str] = Field(
        default=None,
        description="Mud viscosity forcing flag ('F', 'T', 'H', 'C')"
    )
...
class InputAssim(NamelistBaseModel):
    ...
    mean: Optional[str] = Field(
        default=None,
        description="Mean wave assimilation flag ('F', 'T')"
    )
    spec1d: Optional[str] = Field(
        default=None,
        description="1D spectrum assimilation flag ('F', 'T')"
    )
    spec2d: Optional[str] = Field(
        default=None,
        description="2D spectrum assimilation flag ('F', 'T')"
    )
...
class Input(NamelistBaseModel):
    ...
    forcing: Optional[InputForcing] = Field(
        default=None,
        description="Forcing input parameters"
    )
...
class InputGrid(NamelistBaseModel):
    ...
    name: Optional[str] = Field(
        default=None,
        description="Name of the input grid"
    )
    forcing: Optional[InputForcing] = Field(
        default=None,
        description="Forcing input parameters for this grid"
    )
    assim: Optional[InputAssim] = Field(
        default=None,
        description="Data assimilation parameters for this grid"
    )
...
class ModelGridResource(NamelistBaseModel):
    ...
    rank_id: Optional[int] = Field(
        default=None,
        description="Rank number of grid"
    )
    ...
    comm_frac_start: Optional[float] = Field(
        default=None,
        description="Start fraction of communicator"
    )
    comm_frac_end: Optional[float] = Field(
        default=None,
        description="End fraction of communicator"
    )
    bound_flag: Optional[bool] = Field(
        default=None,
        description="Flag identifying dumping of boundary data"
    )
...
class ModelGrid(NamelistBaseModel):
    ...
    forcing: Optional[ModelGridForcing] = Field(
        default=None,
        description="Forcing configuration for this model grid"
    )
    resource: Optional[ModelGridResource] = Field(
        default=None,
        description="Resource configuration for this model grid"
    )